...
//   console.log(retornaValorObjeto({nome: 'pedro', cidade: 'natal'}));
...
//   console.log(retornaChaveObjeto('idade', 24));
  ...
  function retorneObjeto(chave, valor) {
      objeto[chave] = valor
      return objeto;
  }

//   console.log(retorneObjeto('idade', 37));
//   console.log(retorneObjeto('cidade', 'Natal'));
  ...
  console.log(retornaArrayIndice(['pedro', 2, 5, 6], 3))
